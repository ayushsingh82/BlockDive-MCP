  ...
  const handleSubmit = async (e) => {
    ...
    const options = {
      ...
      headers: {
        ...
        'X-API-KEY': 'Vpr4FxPyIscI2DlzIwTSJ3JebtUf5_W1', // Ensure your Arbitrum API key is valid.
      },
    };
    ...
    <div className="flex flex-col items-center justify-center min-h-screen bg-black">
      ...
      <div className="text-gray-300 text-center max-w-2xl mx-auto px-4 mb-8">
        <p className="text-sm leading-relaxed">
          <strong>How this MCP works :</strong> Select an RPC method to interact with the Arbitrum blockchain. The API connects to Nodit's 
          Arbitrum RPC node, executes the selected method, and returns blockchain data including block numbers, gas estimates, 
          block details, and transaction logs. <strong>Input needed:</strong> RPC method selection and method-specific parameters.
        </p>
      </div>
