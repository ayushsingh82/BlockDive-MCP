    ...
    <div className="min-h-screen bg-black flex items-center justify-center">
      ...
      <div className="text-gray-300 text-center max-w-2xl mx-auto px-4 mb-8 absolute top-24 left-1/2 transform -translate-x-1/2">
        <p className="text-sm leading-relaxed">
          <strong>How this MCP works:</strong> Select from various Ethereum token-related API calls including native balance, token metadata, 
          holders, transfers, and ownership. The API connects to Nodit's Web3 Data API for Ethereum mainnet and returns comprehensive 
          token data. <strong>Input needed:</strong> API call type selection and corresponding address (account or contract).
        </p>
      </div>
